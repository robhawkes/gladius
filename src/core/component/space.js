...
define( function ( require ) {
    ...
    return function( engine ) {
        ...
        function( options ) {
            ...
            // TD: Add code to track space partitioning
            ...
            var handleEntityAdded = function( entity ) {
                if( entity ) {                    
                    // Index by id            
            ...
            var handleEntityRemoved = function( entity ) {
                if( entity ) {
            ...
            this.entityAdded.subscribe( handleEntityAdded );
            this.entityRemoved.subscribe( handleEntityRemoved );
